    ...
    <div id="wrapper">
        ...
        <div class="home_style2">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="hm_logo">
                                <a href="index.html"><img src="/images/logo.png" alt="handmade-craft-logo"
            ...
            <div class="hm_banner_wrapper">
                <div class="">
                    <div class="item">
                        <div class="slider_bg" style="background-image:url('/images/a2.jpg');">
                            <div class="container">
                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                <div class="new_pro_img">
                                    <img src="/images/a3.jpg" alt="handmade-craft-arrivals1"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                ...
                                <div class="new_pro_img">
                                    <img src="/images/a4.jpg" alt="handmade-craft-arrivals2"
                                        class="img-responsive" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                <div class="new_pro_img">
                                    <img src="/images/a10.jpg" alt="handmade-craft-arrivals3"
                                        class="img-responsive" />
                                </div>
                                <div class="new_pro_data">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                <div class="new_pro_img">
                                    <img src="/images/a6.jpg" alt="handmade-craft-arrivals4"
                                        class="img-responsive" />
                                </div>
                                <div class="new_pro_data">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                ...
                                <div class="new_pro_img">
                                    <img src="/images/a7.jpg" alt="handmade-craft-arrivals5"
                                        class="img-responsive" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="new_pro_box">
                                <div class="new_pro_img">
                                    <img src="/images/new_pro6.jpg" alt="handmade-craft-arrivals6"
                                        class="img-responsive" />
                                </div>
                                <div class="new_pro_data">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hm_artist_box">
                                <div class="artist_img">
                                    <img src="/images/artist1.jpg" alt="handmade-craft-artist1"
                                        class="img-responsive" />
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hm_artist_box">
                                <div class="artist_img">
                                    <img src="/images/artist2.jpg" alt="handmade-craft-artist2"
                                        class="img-responsive" />
                                </div>
                                <div class="artist_data">
                                    <h3>Martina Carlo</h3>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hm_artist_box artist_right_image">
                                ...
                                <div class="artist_img">
                                    <img src="/images/artist3.jpg" alt="handmade-craft-artist3"
                                        class="img-responsive" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="hm_artist_box artist_right_image">
                                ...
                                <div class="artist_img">
                                    <img src="/images/artist4.jpg" alt="handmade-craft-artist4"
                                        class="img-responsive" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="hm_test_inner">
                            <div class="col-lg-4 col-md-4">
                                <div class="hm_testi_box">
                                    <div class="hm_test_img">
                                        <img src="/images/customer1.png" alt="handmade-craft-customer1"
                                            class="img-responsive" />
                                    </div>
                                    <h2>Hilpton Broad</h2>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="hm_testi_box">
                                    <div class="hm_test_img">
                                        <img src="/images/customer2.png" alt="handmade-craft-customer2"
                                            class="img-responsive" />
                                    </div>
                                    <h2>Stive Philips</h2>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="hm_testi_box">
                                    <div class="hm_test_img">
                                        <img src="/images/customer3.png" alt="handmade-craft-customer3"
                                            class="img-responsive" />
                                    </div>
                                    <h2>James Carlo</h2>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="hm_news_box">
                                <div class="hm_news_img">
                                    <img src="/images/new_pro1.jpg" alt="handmade-craft-blog1"
                                        class="img-responsive">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="hm_news_big_post">
                                <img src="/images/blog_big.jpg" alt="handmade-craft-blog"
                                    class="img-responsive" />
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="hm_news_box">
                                <div class="hm_news_img">
                                    <img src="/images/new_pro2.jpg" alt="handmade-craft-blog2"
                                        class="img-responsive">
                                    <div class="news_img_overlay"></div>
                                    <div class="overlay_buttons">
                                        <a class="popup-news-gallery" href="/images/gallery_big2.jpg"><i
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="hm_news_box">
                                <div class="hm_news_img">
                                    <img src="/images/new_pro3.jpg" alt="handmade-craft-blog3"
                                        class="img-responsive">
                                    <div class="news_img_overlay"></div>
                                    <div class="overlay_buttons">
                                        <a class="popup-news-gallery" href="/images/gallery_big9.jpg"><i
                                                class="fa fa-search" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <div class="hm_news_data">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="hm_news_box">
                                <div class="hm_news_img">
                                    <img src="/images/new_pro4.jpg" alt="handmade-craft-blog4"
                                        class="img-responsive">
                                    <div class="news_img_overlay"></div>
                                    <div class="overlay_buttons">
                                        <a class="popup-news-gallery" href="/images/gallery_big10.jpg"><i
                                                class="fa fa-search" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <div class="hm_news_data">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="hm_partners_slider">
                                <div class="owl-carousel owl-theme test_slider">
                                    <div class="item"><img src="/images/partner1.png"
                                            alt="handmade-craft-clients1"></div>
                                    <div class="item"><img src="/images/partner2.png"
                                            alt="handmade-craft-clients2"></div>
                                    <div class="item"><img src="/images/partner3.png"
                                            alt="handmade-craft-clients3"></div>
                                    <div class="item"><img src="/images/partner4.png"
                                            alt="handmade-craft-clients4"></div>
                                    <div class="item"><img src="/images/partner5.png"
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-12 col-sm-12">
                            <div class="hm_footer_box">
                                <img src="/images/logo.png" alt="handmade-craft-logo" class="img-fluid">
